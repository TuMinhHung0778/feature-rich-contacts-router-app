...
function createSampleContacts() {
  ...
  const samples = [
    ...
    },
    {
      ...
      first: "Julian",
      last: "Tran",
      avatar: "https://avatar.iran.liara.run/public/job/police/female",
      twitter: "julian_cyber",
      email: "julian.tran@cyberwall.vn",
      phone: "+84 93 555 2210",
      ...
      location: "Da Nang, VN",
      notes:
        "Security analyst helping us with quarterly penetration tests. Prefers encrypted email attachments.",
    },
    {
      id: "seed-sofia-le",
      first: "Sofia",
      ...
      twitter: "sofiasketches",
      email: "sofia.le@freelanceart.io",
      phone: "+84 97 889 4412",
      ...
      location: "Hoi An, VN",
      notes:
        "Creates all custom illustrations for marketing campaigns. Send brief at least two weeks ahead.",
    },
    {
      id: "seed-andy-ng",
      first: "Andy",
      last: "Ng",
      avatar: "https://avatar.iran.liara.run/public/job/operator/female?variant=2",
      twitter: "andyng_music",
      email: "andy.ng@echoverse.fm",
      phone: "+65 6123 7788",
      company: "EchoVerse Podcasts",
      category: "friends",
      favorite: true,
      tags: ["audio", "producer", "music"],
      location: "Singapore",
      notes:
        "Podcast producer mixing our upcoming audio series. Loves coffee meetups when visiting Saigon.",
    },
    {
      id: "seed-nora-pham",
      first: "Nora",
      last: "Pham",
      avatar: "https://avatar.iran.liara.run/public/job/doctor/female?variant=2",
      twitter: "nora_community",
      email: "nora.pham@uplift.org",
      phone: "+84 28 7001 4242",
      company: "Uplift Foundation",
      category: "community",
      favorite: false,
      tags: ["non-profit", "events"],
      location: "Thu Duc City, VN",
      notes:
        "Manages monthly community outreach events. Coordinate volunteer schedules with her by the 20th.",
    },
    {
      id: "seed-ryan-chu",
      first: "Ryan",
      last: "Chu",
      avatar: "https://avatar.iran.liara.run/public/job/astronomer/male?variant=2",
      twitter: "ryanchu_ai",
      email: "ryan.chu@orbitallabs.ai",
      phone: "+1 206 555 4920",
      company: "Orbital Labs",
      category: "vip",
      favorite: true,
      tags: ["ai", "space", "investor"],
      location: "Seattle, USA",
      notes:
        "Lead investor interested in quarterly progress demos. Loves getting behind-the-scenes product updates.",
    },
  ];
